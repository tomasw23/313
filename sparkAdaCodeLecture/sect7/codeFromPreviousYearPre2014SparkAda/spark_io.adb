-- $Id$
--------------------------------------------------------------------------------
--(C) 1990-2000 Praxis Critical Systems Limited
--
--The material contained herein is the subject of copyright and all rights in it
--are reserved.  It may not be copied, in whole or in part, without the written
--consent of Program Validation Limited.  Under law copying includes translating
--into another language or format.
--------------------------------------------------------------------------------
--Module File Name   :  SPARKIO.ADS
--Used as part of    :  Spark_IO package for SPARK95
--Module Function    :  Spark IO package body
--Uses Library Units :  Ada.Text_IO
--Author             :  JRG

--Modification History (one line per CFR) :
--Date      CFR   Details of modifications
--15-Jan-90 000   Adoption of source code.
--31-Oct-96 539   Avoidance of predefined FDL indentifiers
--26-Feb-97 614   Changes for Spark95
--18-Nov-99 718   Change to behaviour of Put_String plus new exceptions
--13-Jul-00       New exception added to Close and Delete. Mode of Reset altered
--                as well (MJW)
------------------------------------------------------------------------------
