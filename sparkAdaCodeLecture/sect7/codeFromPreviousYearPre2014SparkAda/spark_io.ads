...
--consent of Praxis Critical Systems.  Under law copying includes translating
--into another language or format.
--------------------------------------------------------------------------------
--Module File Name   :	SPARKIO_.ADA
--Used as part of    :	Spark_IO package for SPARK95
--Module Function    :	Spark_IO package specification
...
--20-Feb-97 614   Changes for SPARK95
--18-Nov-99 718   Annotation changes and extra exceptions
------------------------------------------------------------------------------
